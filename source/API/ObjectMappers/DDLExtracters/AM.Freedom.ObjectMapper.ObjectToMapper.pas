...
begin
  ...
  begin
    ...
    begin
      raise EInvalidFieldAttribute.Create(pColumnClass.ClassName, pField.ToString, BlobColumn.ClassName + ', ' + JoinedColumn.ClassName + ', ' + DetailColumn.ClassName);
    end
    ...
    else if (lColumnType = ctyEnumerator) and not IsValidClass(pColumnClass, [JoinedColumn, EnumerationColumn]) then
    begin
