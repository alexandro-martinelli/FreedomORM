  ...
  begin
    ...
    begin
      ...
      begin
        if (FColumnValueItem.ColumnValue.IsNotNull) then
        begin
          if (FColumn.RttiOptions.RttiField.FieldType.IsOrdinal) then
          begin
            FColumn.RttiOptions.RttiField.SetValue(FColumn.RttiOptions.RttiObject,
                TValue.FromOrdinal(FColumn.RttiOptions.RttiField.FieldType.Handle, FColumnValueItem.ColumnValue));
          end
          else begin
            FColumn.RttiOptions.RttiField.SetValue(FColumn.RttiOptions.RttiObject, TValue.FromVariant(FColumnValueItem.ColumnValue));
          end;
        end;
      end;
    end
